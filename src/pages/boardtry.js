...
export default function todo() {
  ...
  const [perCard, setPerCard] =useState([cards])
  ...
  const addCardList = () => {
    if (item["card"] === "") {
      ...
      setPerCard([...perCard,cards]);
      setAddingCard(false);
      console.log(perCard.cards);
    }
  };
                                ...
                                <div className="grid grid-cols-1 grow mb-3">
                                  <div className="grow ">
                                    ...
                                    <ul className="grid grid-cols-1 mx-2">
                                      {perCard.map((percard, perindex) => {
                                        return (
                                          <section key={perindex}>
                                                <h2>Card: {todoIndex}</h2>
                                                {perCard.percard.map((item, cardIndex) => {
                                                    return(
                                            <li
